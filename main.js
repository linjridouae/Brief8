class Produit{
    constructor(input,input2,input3,input4,input5){
        this.input=input;
        this.input=input2;
        this.input=input3;
        this.input=input4;
    ...
    salut() {
        return "Tous les informations sont dans le tableau";
    }
    
}
let Produit1 = new Produit(input, input2,input3,input4,input5);
let arr = [];
...
let stock = new Produit(input, input2, input3, input4, input5);
arr.push(stock);
